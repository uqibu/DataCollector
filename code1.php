...
for ($i=1000000; $i < 1050000; $i++) {
  ...
  file_put_contents('./url/'.$fileName, $urlContent);

  $transContent = file_get_contents('./url/'.$fileName);
  ...
  $sql = "INSERT INTO user (uid, uname, addressHead, addressFoot, age)
